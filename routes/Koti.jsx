    ...
    <div>
      ...
      <main class="boxtxt">
          ...
          <div class="txtbackround">
            ...
            <img src="/kuvat/tomato.png" name="tomato" onClick={addStuff} className="tomato"/><br></br>
          ...
          <div>
            ...
            <Link to="/Pictures3" class="infotxt3">Pizzasad.
            <img src="/kuvat/pizza.png" className="pizza"
            />     
            </Link>
