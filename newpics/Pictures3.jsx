  ...
  const DraggableComponent = (props) => {
    ...
    return (
      <div className="draggables">
            <img src={"/kuvat/"+ props.aines +"slice.png"} className={props.aines}
  ...
  return (
    ...
    <div>
          ...
          <div>
                ...
                <div class="pictxt">
                  <Link to="/Koti" class="linktxt">Back to Fillings</Link> 
                  </div>
                  <Link to="/Pictures2" list={orderPizza} class="linktxt">Pay & Order</Link>
